...
export default function StudentSettings() { // ← nama fungsi konsisten
  ...
  return (
    <div>
      ...
      <p>Kelola keamanan dan informasi akun Anda sebagai siswa.</p>
      <div style={styles.infoCard}>
        <h3>Informasi Akun</h3>
        <div style={styles.infoRow}><strong>Email:</strong> {profile.email}</div>
        <div style={styles.infoRow}><strong>Role:</strong> {profile.role === "murid" ? "Siswa" : "Pengguna"}</div>

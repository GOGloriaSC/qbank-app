...
export default function TeacherDashboard() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      if (userRole === "teacher") await fetchStats();
      setLoading(false);
    };
    loadData();
  ...
  const handleSubmitAnswer = async (questionId, selectedAnswer) => {
    ...
    if (userRole !== "student") {
      alert("Hanya student yang bisa menjawab soal.");
      return;
    }
  ...
  const handleArchive = async (id) => {
    ...
    //log aktivitas
    await logActivity("question_archive", `Mengarsipkan soal dari bank soal publik`, id);
  };
      ...
      <div style={styles.publishSection}>
        ...
        <p>
          {userRole === "student"
            ...
            : "Berikut soal-soal yang telah dipublikasi. teacher dapat mengarsipkan (menyalin ke arsip) atau menghapus soal."}
        </p>

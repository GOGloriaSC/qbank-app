...
export default function AdminLayout() {
  ...
  useEffect(() => {
    const getUser = async () => {
      ...
      if (user) {
        ...
        setProfile({
          name: profileData?.name || user.email?.split("@")[0] || "Admin",
          email: user.email,
        });
      }
    };
  ...
  // Menu items: Dashboard + Add Member
  const menuItems = [
    { path: "/admin", icon: "📊", tooltip: "Dashboard", exact: true, badge: null },
    { path: "/admin/User-Management", icon: "👥", tooltip: "User Management", exact: false, badge: null },
    { path: "/admin/silabus", icon: "📚", tooltip: "Silabus", exact: false, badge: null },
    { path: "/admin/activity", icon: "📈", tooltip: "Activity User", exact: false, badge: null },
  ];
      ...
      <div className="admin-layout">
        <header className="admin-header">
          ...
          <form className="search-form" onSubmit={(e) => {
            ...
            <input
              type="text"
              placeholder="Cari user, soal, atau laporan..."
